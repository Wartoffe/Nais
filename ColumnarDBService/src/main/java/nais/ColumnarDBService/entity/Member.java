...
public class Member {
    ...
    @PrimaryKeyColumn(name = "jmbg", type = PrimaryKeyType.PARTITIONED)
    private UUID jmbg;
    ...
    public Member(UUID jmbg, String fullName, String email, String phone, LocalDateTime membershipDate, boolean active) {
        this.jmbg = jmbg;
